...
## subset data frame to get only MALE MZ pairs
MZ_twinsExpression_df <- subset(twinsExpression, TWIN > 0 & Sex == 1)
...
#temp_check <- is.element(seconditergplwright_discordant_generaldf[,1],intersect(probe_id_gsewright_discordant_general,seconditergplwright_discordant_generaldf[,1]))
...
#saveRDS(genelevelvaluegsewright_discordant_generaldf, '/home/st320/second_iter_gse_genelevel_dfs/male_genelevelvalue_plain_t_test_gsewright_discordant_generaldf.RDS')
